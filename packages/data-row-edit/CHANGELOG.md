...
* **data-row-edit:** check for empty file value ([ddc856f](https://github.com/sidohaakma/molgenis-frontend/commit/ddc856f)), closes [#28](https://github.com/sidohaakma/molgenis-frontend/issues/28)


### Features

* **data-row-edit:** upgrade form dependency to 3.0.0 ([a175ce6](https://github.com/sidohaakma/molgenis-frontend/commit/a175ce6))
